...
int main(){    
    ...
    for(int rotate_num=0;rotate_num<K;rotate_num++){
        ...
        int * rotate_info = new int[chain_total];
        // -99는 아무것도 안들어갔다는 의미
        for(int i=0;i<chain_total;i++) rotate_info[i]=-99;
    ...
    int s_num = 0;
    for(int i=0;i<chain_total;i++) s_num += chains[i][0];
    cout << s_num;
